...
During the development of this project, LLMs were primarily used for research prior to (or while) implementing a feature.
...
This proved a great use for LLMs, primarily ChatGPT, Claude, or Gemini, to be used in the context of clarifying a subject from various internet sources.
...
Another issue we faced with LLMs was that when researching topics, they would often get confused and produce increasingly inconsistent or incorrect responses.
